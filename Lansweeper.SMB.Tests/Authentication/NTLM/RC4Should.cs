...
internal class RC4Should
{
    ...
    public void Test1()
    {
        ...
        cipher.Should().Equal(expectedCipher);
    }
    ...
    public void Test2()
    {
        ...
        byte[] text = [0xDC, 0xEE, 0x4C, 0xF9, 0x2C];
        byte[] expectedCipher = [0xF1, 0x38, 0x29, 0xC9, 0xDE];
        byte[] cipher = RC4.Encrypt(key, text);
        cipher.Should().Equal(expectedCipher);
    }
    ...
    public void Test3()
    {
        byte[] key = [ 0x29, 0x04, 0x19, 0x72, 0xFB, 0x42, 0xBA, 0x5F,
                       0xC7, 0x12, 0x77, 0x12, 0xF1, 0x38, 0x29, 0xC9];
        byte[] text = [ 0x52, 0x75, 0x69, 0x73, 0x6c, 0x69, 0x6e, 0x6e,
        ...
        byte[] expectedCipher = [ 0x35, 0x81, 0x86, 0x99, 0x90, 0x01, 0xe6, 0xb5,
